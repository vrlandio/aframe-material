...
/***/ (function(module, exports, __webpack_require__) {
	...
	Behaviors.keyClick = function (keyEl) {
	  ...
	  var type = keyEl.getAttribute('key-type');
	  var value = keyEl.getAttribute('key-value');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Utils = __webpack_require__(6);
	var Event = __webpack_require__(4);
	var Assets = __webpack_require__(45);
	var SFX = __webpack_require__(46);
	...
	AFRAME.registerComponent('slider', {
	  ...
	  updateForegroundOpacity: function updateForegroundOpacity(opacity) {
